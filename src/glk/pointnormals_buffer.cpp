...
: PointNormalsBuffer(vertices.empty() ? nullptr : vertices[0].data(), sizeof(Eigen::Vector3f), normals.empty() ? nullptr : normals[0].data(), sizeof(Eigen::Vector3f), vertices.size(), normal_length) {}
