...
: ThinLines(num_vertices > 0 ? vertices->data() : nullptr, nullptr, convert_scalars<float>(cmap, num_vertices).data(), num_vertices, nullptr, 0, line_strip, line_width) {}
...
: ThinLines(num_vertices > 0 ? vertices->data() : nullptr, nullptr, convert_scalars<float>(cmap, num_vertices).data(), num_vertices, indices, num_indices, line_strip, line_width) {}
