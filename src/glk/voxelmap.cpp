...
std::shared_ptr<glk::GLSLShader> VoxelMap2::shader = nullptr;

VoxelMap2::VoxelMap2(const Eigen::Vector3i* voxel_coords, int num_voxels, double resolution, const MeshRenderingOptions& options) : options(options) {
  this->num_voxels = num_voxels;
...
VoxelMap2::VoxelMap2(const std::vector<Eigen::Vector3i>& voxel_coords, double resolution, const MeshRenderingOptions& options)
: VoxelMap2(voxel_coords.data(), voxel_coords.size(), resolution, options) {}

// Deprecated constructor
VoxelMap2::VoxelMap2(const Eigen::Vector3i* voxel_coords, int num_voxels, double resolution, const VoxelMapOptions& options) {}
...
void VoxelMap2::draw(glk::GLSLShader& shader_) const {
  shader->use();
